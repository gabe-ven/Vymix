...
with_node \
  ...
  --target "/Users/gabrielvenezia/Vymix/ios/Pods/Target Support Files/Pods-Vymix/ExpoModulesProvider.swift" \
  --entitlement "/Users/gabrielvenezia/Vymix/ios/Vymix/Vymix.entitlements" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo" "expo-apple-authentication" "expo-application" "expo-asset" "expo-av" "expo-blur" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-random" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-system-ui" "expo-web-browser"
